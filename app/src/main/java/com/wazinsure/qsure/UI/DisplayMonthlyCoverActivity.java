...
public class DisplayMonthlyCoverActivity extends AppCompatActivity implements  View.OnClickListener {
    ...
    private static final String PA_URL = "https://demo.wazinsure.com:4443/api/pacovers/1";
    ...
    private void getMonthlyCover() {
        ...
        if (!checkConnection.isConnectedToInternet(getApplicationContext())) {
            ...
            progressDialog.setMessage("Getting Monthly Cover..");
