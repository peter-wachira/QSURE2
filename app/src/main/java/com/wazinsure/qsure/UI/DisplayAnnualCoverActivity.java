...
public class DisplayAnnualCoverActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private static final String PA_URL = "https://demo.wazinsure.com:4443/api/pacovers/6";
    ...
    private void getAnnualCover() {
        ...
        if (!checkConnection.isConnectedToInternet(getApplicationContext())) {
            ...
            progressDialog.setMessage("Getting Annual Cover..");
